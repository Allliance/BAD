...
def find_best_eps(eps_lb, eps_ub, eps_step, validation_function, max_error=1e-3, partition=10, verbose=False):
    '''
    ...
    if eps_step > max_error:
        ...
        if progress:
            ...
            print(f"Recursively calling the function with new step size {new_eps_step}")
